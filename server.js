...
const corsOptions = {
    origin: process.env.NODE_ENV === 'production'
        ? [
            process.env.CLIENT_URL || 'https://juegomemoriacliente5.onrender.com',
            'https://juegomemoriacliente5.onrender.com' // Sin la barra al final
        ]
        : ['http://localhost:3000'],
    methods: ['GET', 'POST'],
    credentials: true
...
console.log('URL del cliente:', process.env.CLIENT_URL || 'https://juegomemoriacliente5.onrender.com');
